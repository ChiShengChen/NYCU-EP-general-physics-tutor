        ...
        <div className="max-w-4xl mx-auto">
          {loading && (
            <div className="flex flex-col items-center justify-center h-64 gap-3">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">AI 正在抽出 {chLabel} 核心概念...（首次約 6–10 秒）</p>
            </div>
          )}
  ...
  return (
    <div className={`border rounded-2xl p-5 shadow-sm ${sty.card}`}>
      <div className="flex items-start gap-2 mb-2">
        ...
        <h3 className={`font-semibold text-slate-800 dark:text-slate-100 ${sty.accent}`}>{concept.title}</h3>
      </div>
